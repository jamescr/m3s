 ...
 *
 */
public class TaxonDAOImpl extends GenericBaseDAOImpl<Taxon,Integer> implements TaxonDAO {

	private static Logger logger = Logger.getLogger(TaxonDAOImpl.class);
	...
	public Taxon findBySpecimenId(Integer specimenId)
			throws IllegalArgumentException {
		//FIXME
		return (Taxon) new Taxon(new Integer(7), new Integer(1), "falta hacer", new Date(), "falta hacer", new Integer(1), "falta hacer");
	}
